type FrenchNumberWords = Record<number, string>;

const FRENCH_NUMBER_WORDS: FrenchNumberWords = {
 ...
 */
export function convertNumberToLetter(nb: number): string {
 ...
 * @returns La représentation en lettres du nombre.
 */
function numberToLetterUnderTwenty(nb: number): string {
 ...
 * @returns La représentation en lettres du nombre.
 */
function numberToLetterBetweenTwentyAndHundred(nb: number): string {
 ...
 * @returns La représentation en lettres du nombre.
 */
function numberToLetterBetweenHundredAndThousand(nb: number): string {
 ...
 * @returns La représentation en lettres du nombre.
 */
function numberToLetterBetweenThousandAndMillion(nb: number): string {
 ...
 * @returns La représentation en lettres du nombre.
 */
function numberToLetterBetweenMillionAndBillion(nb: number): string {
 ...
 * @returns La représentation en lettres du nombre.
 */
function numberToLetterAboveBillion(nb: number): string {
